...
public final class ReadEpubFilePackageTool implements AgentTool {
    ...
    private ToolResult convertResult(Path epubFile, String packagePath, Element packageElement) {
        ...
        String prefix = trimToEmpty(packageElement.getAttribute("prefix"));
        String language = readLanguage(packageElement);
        String direction = trimToEmpty(packageElement.getAttribute("dir"));
    ...
    private String readLanguage(Element packageElement) {
